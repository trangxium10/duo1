...
$postsLifestyle = [];
if ($pdo) {
    $stmt = $pdo->prepare("SELECT p.id, p.user_id, p.title, p.content, p.created_at, p.thumbnail, p.is_private, u.nom, u.prenom FROM posts p LEFT JOIN utilisateurs u ON p.user_id = u.id WHERE p.category = :cat ORDER BY p.created_at DESC LIMIT 3");
...
<body class="page-accueil">
                            ...
                            <?php foreach($postsLivres as $rp): ?>
                                ...
                                <div style="display:flex;gap:8px;margin-bottom:8px">
                                    ...
                                    <div>
                                        ...
                                        <?php if (isset($_SESSION['user']) && isset($_SESSION['user']['id']) && $_SESSION['user']['id'] == ($rp['user_id'] ?? null)): ?>
    ...
    <footer>
        <p style="color:#fff">© 2026 DUO — Tous droits réservés</p>
    </footer>
