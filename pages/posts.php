...
<nav>
    ...
    <?php
        ...
        <a href="create_post.php">Créer</a>
    <?php endif; ?>
                        ...
                        <?php if($thumb): ?>
                            <div style="width:140px;flex:0 0 140px;position:relative">
                                ...
                                <?php if($isPrivate && !isset($_SESSION['user'])): ?>
                                    <div style="position:absolute;left:8px;top:8px;background:rgba(0,0,0,0.6);color:#fff;padding:6px;border-radius:6px;font-weight:700">🔒 Privé</div>
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
                        <div style="flex:1">
            ...
            <?php else: ?>
                <?php foreach($postsLifestyle as $p): ?>
                    ...
                    <article style="border:1px solid #ccc;padding:12px;margin:10px 0;display:flex;gap:12px">
                        ...
                        <?php endif; ?>
                        <div style="flex:1">
                            <h3><a href="<?php echo $link; ?>"><?php echo htmlspecialchars($p['title']); ?></a></h3>
